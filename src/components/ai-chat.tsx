          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3 border-b border-white/5 bg-gradient-to-r from-blue-500/10 to-cyan-500/10">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-base font-semibold text-white">MACD AI Assistant</h3>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 scrollbar-none">
              {messages.map((msg) => (
                ...
                >
                  ...
                  <div
                    className={`max-w-[85%] rounded-xl px-3 py-2 text-base leading-relaxed ${
                      msg.role === "user"
            ...
            <div className="px-3 py-2 border-t border-white/5 flex gap-1.5 overflow-x-auto scrollbar-none">
              {quickActions.map((action) => (
                <button
                  ...
                  className="px-2.5 py-1 rounded-full bg-white/5 hover:bg-white/10 text-sm text-slate-400 hover:text-white whitespace-nowrap transition-colors flex-shrink-0"
                >
                  {action}
                </button>
              ))}
